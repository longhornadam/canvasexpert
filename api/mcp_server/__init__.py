...
keeps sole custody of the Canvas PAT and almost every write path — this
package writes to Canvas only through one explicit, digest-protected roster
tool (``canvas_group``), and never binds a network port.
