...
| Glass | `api/webui/README.md`, then the active Glass handoff section | Local classroom display; preserve route-specific load order, independent region degradation, and zero direct Canvas client imports. |
