# Historical execution brief 11d1: QuizForge plan and whole-class operation
...
Reject differentiated mode with a safe 400 until 11d2. (Note: 11d2 is now released;
the adapter supports `mode="differentiated"`.)
